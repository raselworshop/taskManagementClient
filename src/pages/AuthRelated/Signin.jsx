...
import logo from "../../assets/signin.json";
...
const Signin = () => {
  const { signInUser, signinWithPop } = useAuth();
  ...
  const handleGoogleSignIn = async () => {
    try {
      setLoading(true);
      await signinWithPop().then((result) => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      // console.log("User unsuccesfull to signed in, please try again!")
      toast.error(
        error.message || "User unsuccesfull to signed in, please try again!"
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="flex flex-col md:flex-row items-center container mx-auto overflow-hidden rounded-lg shadow-lg ">
        ...
        <div className="md:w-1/2 px-6 py-8">
            ...
            <div className="mt-4">
              <div className="relative">
                ...
                <input
                  ...
                  name="password"
                  className="block w-full px-4 py-2  dark:border-dark-border dark:bg-dark-background dark:text-white  text-gray-700 border rounded-lg focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <Link to="/joinus" className="text-xs uppercase  hover:underline">
              or sign up
            </Link>
